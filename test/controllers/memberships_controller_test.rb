...
class MembershipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create membership" do
    assert_difference("Membership.count") do
      post memberships_url, params: { membership: { beerclub_id: @membership.beerclub_id, user_id: @membership.user_id } }
    end
  ...
  test "should update membership" do
    patch membership_url(@membership), params: { membership: { beerclub_id: @membership.beerclub_id, user_id: @membership.user_id } }
